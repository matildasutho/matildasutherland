...
var trailLength = 7 // The length of trail (8 by default; put more for longer "tail")
var path = "img/star-trail.png" // URL of your image
...
function initTrail() { // prepares the script
    ...
    for (i = 0; i < images.length; i++) { // make divs for IE and layers for Navigator
        document.write('<div id="obj' + i + '" style="position: absolute; z-Index: -5; height: 0; width: 0"><img width=50 height=50 style="opacity: 0.5;" src="' + images[i].src + '"></div>')
    }
    trail()
}
